...
import com.bp.common.utils.TypeConversionUtils;
...
public class LogAop {
     ...
     */
    @Around(value = "@annotation(com.bp.common.anno.LogAnnotation)")
    public Object logSave(ProceedingJoinPoint joinPoint) throws Throwable {
        Log log = new Log();
        log.setCreateTime(new Date());
        LoginUser currentUser = UserUtils.getCurrentUser();
        log.setUsername(currentUser == null ? "0" : currentUser.getUsername());
        log.setName(currentUser == null ? "0" : currentUser.getName());
