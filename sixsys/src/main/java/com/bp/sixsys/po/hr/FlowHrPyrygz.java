...
@AllArgsConstructor
@Data
@ApiModel(value = "聘用人员工作")
@TableName(value = "flow_hr_pyrygz")
public class FlowHrPyrygz extends BaseEntityUUID {
     ...
     * 确定已公示5个工作日
     */
    @ApiModelProperty(value = "确定已公示5个工作日")
    private String qdygswggzr;
     ...
     * 招聘人员及其工资待遇
     */
    @ApiModelProperty(value = "招聘人员及其工资待遇")
    private String zpryjqgzdy;
     ...
     * 聘用手续相关文件
     */
    @ApiModelProperty(value = "聘用手续相关文件")
    private String pysx;

    /**
     * 确定人员及工资待遇
     */
    @ApiModelProperty(value = "确定人员及工资待遇")
    private String qdryjgzdy;

    /**
     * 确定已公示三个工作日
     */
    @ApiModelProperty(value = "确定已公示三个工作日")
    private String qdygssggzr;
