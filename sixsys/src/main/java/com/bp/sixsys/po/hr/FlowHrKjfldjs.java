...
@AllArgsConstructor
@Data
@ApiModel(value = "科级非领导职务晋升工作")
@TableName(value = "flow_hr_kjfldjs")
public class FlowHrKjfldjs extends BaseEntityUUID {

    /**
     * 晋升人员信息（json格式）
     */
    @ApiModelProperty(value = "晋升人员信息（json格式:警察编码、姓名、现任职务、近三年公务员年度考核结果是否为称职以上）")
    private String jsry;
