...
@AllArgsConstructor
@Data
@ApiModel(value = "中队级领导干部选拔任用工作")
@TableName(value = "flow_hr_zdjldgbxb")
public class FlowHrZdjldgbxb extends BaseEntityUUID {

    /**
     * 警察信息（json格式:{警察编码，拟任职务，称职情况，是否在党纪政纪处分期内，是否为中共正式党员，本年度病、事假是否超过三个月}）
     */
    @ApiModelProperty(value = "警察信息（json格式:{警察编码，拟任职务，称职情况，是否在党纪政纪处分期内，是否为中共正式党员，本年度病、事假是否超过三个月}）")
    private String jcxx;
     ...
     * 支委会召开时间
     */
    @ApiModelProperty(value = "支委会召开时间")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd")
    private Date zwhzksj;

    /**
     * 支委会意见内容
     */
    @ApiModelProperty(value = "支委会意见内容")
    private String zwhyjnr;
