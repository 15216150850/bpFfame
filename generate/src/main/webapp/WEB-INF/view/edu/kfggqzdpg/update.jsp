...
<form class="layui-form layui-form-pane" id="bpForm" style="padding: 25px 10px" lay-filter="bpForm">
    ...
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">法律常识得分</label>
            <div class="layui-input-block">
                <input type="text" name="flcsdf" id="flcsdf" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">思想道德得分</label>
            <div class="layui-input-block">
                <input type="text" name="sxdddf" id="sxdddf" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">戒毒常识得分</label>
            <div class="layui-input-block">
                <input type="text" name="jdcsdf" id="jdcsdf" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">戒毒康复教育得分</label>
            <div class="layui-input-block">
                <input type="text" name="jdkfjydf" id="jdkfjydf" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">文化素质教育得分</label>
            <div class="layui-input-block">
                <input type="text" name="whszjydf" id="whszjydf" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: basePath+"/edu/kfggqzdpg/"+GetRequest().uuid,
        async:false,
        beforeSend: function () {
            return loading();
        },
    ...
    layui.config({
    	...
    	form.val('bpForm', {
            ...
            "flcsdf": formData.flcsdf,
            "sxdddf": formData.sxdddf,
            "jdcsdf": formData.jdcsdf,
            "jdkfjydf": formData.jdkfjydf,
            "whszjydf": formData.whszjydf,
