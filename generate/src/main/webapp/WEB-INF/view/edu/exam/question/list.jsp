...
<div class="bp_wapper">
    ...
    <div class="nav-top">
       <div class="left">
            <div>
                <span id="insert"  permission="edu/exam:question:insert"><i class="layui-icon layui-icon-add-1"></i>添加</span>
                <span id="update"  permission="edu/exam:question:update"><i class="layui-icon layui-icon-edit" ></i>编辑</span>
                <span id="delete"  permission="edu/exam:question:delete"><i class="layui-icon layui-icon-delete"></i>删除</span>
            </div>
        </div>
        <div class="right">
...
<script type="text/javascript">
    ...
    layui.config({
        ...
        table.render({
            ...
            url: basePath+"/edu/exam/question/list",
            method: "get",
            height:"full-100",
            cellMinWidth: 100,
            where: {},
                ...
                [
                    {
                        type: "checkbox"
                            ...
                            ,{
                                field: "answerRaw",
                                title: "答案（单选题填写答案序号，如1；多选题填写答案序号，如13；填空题填写答案文本）",
                                align: "center"
                            }
                ]
            ],
        ...
        table.on('rowDouble(bpTable)', function (obj) {
            var data = obj.data;
            openDialogView("查看exam_question信息", "/views/edu/exam/question/see.html?uuid=" + data.uuid, "1000px", "600px");
        });
        ...
        form.on('submit(formDemo)', function(data){
            var url = basePath+"/edu/exam/question/list?" +$("#bpForm").serialize();
            table.reload('bpTable', {
                url: url,
                page: {
                    curr: 1 //重新从第 1 页开始
        ...
        $("#insert").click(function () {
            openDialogVerify("新增exam_question信息", "/views/edu/exam/question/insert.html", "1000px", "600px");
        });
        ...
        $("#delete").click(function () {
            ...
            if (ids == "") {
                ...
                confirmx("你确定" + data.length + "条数据删除吗？", function () {
                    $.ajax({
                        type: "DELETE",
                        url: basePath+"/edu/exam/question?uuids="+ids,
                        beforeSend: function () {
                            return loading();
                        },
                        success: function (rb) {
        ...
        $("#update").click(function () {
            ...
            openDialogVerify("修改exam_question信息", "/views/edu/exam/question/update.html?uuid=" + uuid, "1000px", "600px");
        });
