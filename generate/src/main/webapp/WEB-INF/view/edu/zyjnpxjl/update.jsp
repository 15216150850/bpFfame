...
<script>
    ...
    $.ajax({
        type: "GET",
        url: basePath+"/edu/zyjnpxjl/"+GetRequest().uuid,
        async:false,
        beforeSend: function () {
            return loading();
        },
    ...
    layui.config({
    	...
    	form.val('bpForm', {
            ...
            "zyjnpxbh": formData.zyjnpxbh,
            "pxrq": formData.pxrq,
            "hdjzss": formData.hdjzss,
            "hzrq": formData.hzrq,
            "hdjzsmc": formData.hdjzsmc,
            "zsjb": formData.zsjb,
            "fzjg": formData.fzjg,
            "sfjytj": formData.sfjytj,
            "jytsrq": formData.jytsrq,
        	"uuid":formData.uuid
        });
