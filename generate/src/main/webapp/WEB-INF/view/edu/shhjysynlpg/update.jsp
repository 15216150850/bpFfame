...
<form class="layui-form layui-form-pane" id="bpForm" style="padding: 25px 10px" lay-filter="bpForm">
    ...
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">生活来源及居所情况</label>
            <div class="layui-input-block">
                <input type="text" name="shlyjjsqk" id="shlyjjsqk" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">职业能力情况</label>
            <div class="layui-input-block">
                <input type="text" name="zynlqk" id="zynlqk" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">社会支持情况</label>
            <div class="layui-input-block">
                <input type="text" name="shzcqk" id="shzcqk" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">接受社会监督和援助意愿情况</label>
            <div class="layui-input-block">
                <input type="text" name="jsshjdhyzyyqk" id="jsshjdhyzyyqk" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
            <label class="layui-form-label">家庭功能恢复情况</label>
            <div class="layui-input-block">
                <input type="text" name="jtgnhfqk" id="jtgnhfqk" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    <div class="layui-row layui-col-space10 layui-form-item">
        <div class="layui-col-lg6 layui-col-xs12 layui-col-sm6">
...
<script>
    ...
    $.ajax({
        type: "GET",
        url: basePath+"/edu/shhjysynlpg/"+GetRequest().uuid,
        async:false,
        beforeSend: function () {
            return loading();
        },
    ...
    layui.config({
    	...
    	form.val('bpForm', {
            ...
            "shlyjjsqk": formData.shlyjjsqk,
            "zynlqk": formData.zynlqk,
            "shzcqk": formData.shzcqk,
            "jsshjdhyzyyqk": formData.jsshjdhyzyyqk,
            "jtgnhfqk": formData.jtgnhfqk,
